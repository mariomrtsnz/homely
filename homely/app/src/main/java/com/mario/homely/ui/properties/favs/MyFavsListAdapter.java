...
public class MyFavsListAdapter extends RecyclerView.Adapter<MyFavsListAdapter.ViewHolder> {
    private final MyFavsListListener mListener;
    UserResponse user;
    ...
    public MyFavsListAdapter(Context ctx, List<PropertyResponse> data, MyFavsListListener mListener) {
        this.data = data;
        this.context = ctx;
